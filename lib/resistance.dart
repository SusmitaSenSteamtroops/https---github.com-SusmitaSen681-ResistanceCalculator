...
import 'package:resistor_calculator/mypainter.dart';
...
class _ResistanceFindState extends State<ResistanceFind> {
  ...
  var arra = List<Container>.generate(6, (index) => Container());
  var arr = List<Color>.generate(11, (index) => Colors.amber);
  ...
  Future<Null> init() async {
    final ByteData data = await rootBundle.load('images/res.png');
    image = await loadImage(data.buffer.asUint8List());
  }

  /*Future loadImage(String path) async {
    final data = await rootBundle.load('images/res.png');
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Text(
                  getAnswer(
                      _selectedResistor.id, getTolerance(_selectedResistor.id)),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 30,
                    color: Colors.white,
                ...
                Padding(
                  ...
                  child: CustomRadioButton(
                    ...
                    height: 50, unSelectedColor: Colors.green,
                  ),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        ...
                        ? Column(
                            children: <Widget>[
                              ...
                              FloatingActionButton(
                                ...
                                onPressed: () {
                                  _openColorPicker(
                                      4, getTolerance(_selectedResistor.id));
                                },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 200, 230, 244),
      body: SafeArea(
